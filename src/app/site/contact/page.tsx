                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white border border-[var(--color-warm-gray)] text-[var(--color-charcoal)] focus:outline-none focus:border-[var(--color-orange)] transition-colors appearance-none"
                    >
