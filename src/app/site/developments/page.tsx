...
export const metadata: Metadata = {
  ...
  description: "Explore our current smart home developments in prime Lagos locations.",
};

const developments = [
  {
    id: "zithelo-signature-homes-1",
    ...
    status: "Now Selling",
    slug: "zithelo-signature-homes-1",
  },
  {
    id: "andoyi-place",
    title: "Andoyi Place",
                ...
                <Link href={`/developments/${dev.slug}`} className="group block">
                  <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                      <span className="text-xs uppercase tracking-[0.2em] text-[var(--color-orange)]">
                        {dev.status}
                      </span>
